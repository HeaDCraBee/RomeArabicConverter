...
namespace RomeArabicConverter
{
    ...
    {
        private delegate double PowTen();
        ...
        {
            var romeToArabicDictionary = RomeToArabicDictionary.getRomeToArabicDictionary();
        ...
        public static string ToRome(int number)
        {
            ...
            foreach (var pair in RomeToArabicDictionary.getRomeToArabicDictionary())
            {
